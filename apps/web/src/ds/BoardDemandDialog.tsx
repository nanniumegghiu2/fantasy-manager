      ...
      >
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="text-body leading-tight font-extrabold">
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto p-4">
          ...
          <button
            ...
            className="flex w-full items-start gap-3 rounded-card border border-[var(--surface-border)] bg-[var(--surface-raised)] p-3 text-left transition-transform active:scale-98"
          >
            <UserMinus size={16} className="mt-0.5 shrink-0 text-[var(--brand)]" />
            <span className="min-w-0">
              <span className="block text-body font-extrabold">Esonera {demand.coachName}</span>
