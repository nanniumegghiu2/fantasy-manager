...
- **Tabella Giocatori ordinabile**: ogni colonna (nome, club, campionato, epoca, reparto, Overall) è cliccabile per ordinare crescente/decrescente — reparto ordinato per gerarchia di ruolo (POR/DIF/CC/ATT), non alfabetica. Su mobile (dove le intestazioni di colonna non sono visibili) un menu a tendina "Ordina per" replica lo stesso stato di ordinamento.
